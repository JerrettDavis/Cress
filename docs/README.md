...
| [User guide](user-guide/index.md) | Studio walkthroughs with `Cress.Studio.Web` as the primary shell, recording flows, authoring guidance, debugging, target-specific guides for CLI, service, web, and desktop testing, and step-by-step familiar-app walkthroughs |
